...
namespace Cuelogic.Clrm.Service.Tests.TestCase
{
    ...
    public class MasterDepartmentServiceTest
    {
        ...
        public void TestMasterDepartmentServiceGetItem()
        {
            ...
            //ASSERT
            mockService.Verify(m => m.GetMasterDepartment(It.IsAny<int>()));
            mockService.Verify(m => m.GetMasterDepartment(It.IsAny<int>()), Times.Once);
            mockService.Verify();
        ...
        public void TestMasterDepartmentServiceGetList()
        {
            ...
            //ASSERT
            mockService.Verify(m => m.GetMasterDepartmentList(It.IsAny<SearchParam>()));
            mockService.Verify(m => m.GetMasterDepartmentList(It.IsAny<SearchParam>()), Times.Once);
            mockService.Verify();
            Assert.IsNotNull(data);
            Assert.IsTrue(data != "");
