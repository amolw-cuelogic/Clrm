...
namespace Cuelogic.Clrm.Service.Tests.EmployeeTest
{
    ...
    public class EmployeeServiceTest
    {
        ...
        public void TestEmployeeServiceGetItem()
        {
            ...
            var serviceObject = new EmployeeService();
            var privateObject = new PrivateObject(serviceObject);
            var mockDataEmployeeVm = EmployeeServiceMockData.GetMockDataEmployeeVm();
            var mockDataEmployee = EmployeeServiceMockData.GetMockDataEmployee();
        ...
        public void TestEmployeeServiceGetList()
        {
            ...
            var serviceObject = new EmployeeService();
            var privateObject = new PrivateObject(serviceObject);
            var mockData = EmployeeServiceMockData.GetMockDataEmployeeDataset();
            ...
            var expectedResult = EmployeeServiceMockData.GetMockDataemployeeList();
        ...
        public void TestEmployeeServiceSave()
        {
            ...
            var serviceObject = new EmployeeService();
            var privateObject = new PrivateObject(serviceObject);
            var mockdata = EmployeeServiceMockData.GetMockDataEmployeeVm();
