...
export class AllocationComponent {
    ...
    NewRecord() {
        this.router.navigate(['/allocation/' + this.formMode.Add + '/0']);
    }

    EditRecord(id: any) {
        this.router.navigate(['/allocation/' + this.formMode.Edit + '/' + id]);
    }

    ViewRecord(id: any) {
        this.router.navigate(['/allocation/' + this.formMode.View + '/' + id]);
    }
