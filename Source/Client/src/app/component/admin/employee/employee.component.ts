...
export class EmployeeComponent {
    ...
    NewRecord() {
        this.router.navigate(['/employee/' + this.formMode.Add + '/0']);
    }

    EditRecord(id: any) {
        this.router.navigate(['/employee/' + this.formMode.Edit + '/' + id]);
    }

    ViewRecord(id: any) {
        this.router.navigate(['/employee/' + this.formMode.View + '/' + id]);
    }
