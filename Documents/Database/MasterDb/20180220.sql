...
INSERT INTO `MasterSkill` VALUES (1,'as','',1,'2018-02-19',1,'2018-02-20'),(2,'c#','',1,'2018-02-19',1,'2018-02-20'),(3,'676','',1,'2018-02-19',1,'2018-02-19');
...
--
/*!50003 DROP PROCEDURE IF EXISTS `spEmployeeVm_GetValidList` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `spEmployeeVm_GetValidList`()
BEGIN
...
BEGIN
	...
	LEFT JOIN 
		Employee c ON a.CreatedBy = c.Id
	WHERE
		a.Id = employeeId;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `spIdentityGroupRight_BulkUpdate`(IN xmltext text)
BEGIN
	DECLARE i INT DEFAULT 1;
	DECLARE nodeCount INT(11);
	SET nodeCount = ExtractValue(xmltext, 'count(/ArrayOfIdentityGroupRight/IdentityGroupRight)');
...
-- Dump completed on 2018-02-20 19:16:01
