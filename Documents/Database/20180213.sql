...
INSERT INTO `IdentityGroup` VALUES (1,'jk,jk','SuperAdmin','',1,'2018-02-05',1,'2018-02-13'),(13,'as as','Admin','',1,'2018-02-06',1,'2018-02-13'),(14,'Staffone','Staff','',1,'2018-03-06',1,'2018-02-13'),(15,'User','User','',1,'2018-02-07',NULL,NULL),(16,'Employee','Employee','',1,'2018-02-08',NULL,NULL),(17,'Hr','Hr','',1,'2018-02-10',NULL,NULL),(18,'Sales','Sales','',1,'2018-02-12',NULL,NULL),(19,'Delivery','Delivery','',1,'2017-10-06',NULL,NULL),(20,'Non Technical','Non Technical','',1,'2018-03-14',NULL,NULL),(21,'Infrastructure','Infrastructure','',1,'2018-02-21',NULL,NULL),(22,'Hardware','Hardware','',1,'2018-02-28',NULL,NULL),(23,'Interior','Interior','',1,'2018-01-01',NULL,NULL);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `spUpdateIdentityGroup1` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `spUpdateIdentityGroup1`()
BEGIN
update IdentityGroup set 
GroupName = @grpname,
...
-- Dump completed on 2018-02-13 15:16:13
